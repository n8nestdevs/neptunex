    ...
    <div className="bg-navy-800 rounded-lg border border-navy-700 p-3">
      ...
      <div className="flex items-center gap-2 mb-4">
        <select
          ...
          className="min-w-0 flex-1 bg-navy-900 border border-navy-700 rounded px-2 py-2 text-slate-200"
        >
        ...
        <button
          ...
          onClick={addItem}
          disabled={!selectedId}
          className="flex-shrink-0 px-3 py-2 rounded bg-teal-500 text-navy-900 font-semibold border border-teal-400 disabled:opacity-50"
        >
          Add
        </button>
      </div>
