...
import { Ship, Database, AlertTriangle } from 'lucide-react';

/* ===========================
   ÍCONOS ORIGINALES (SVG)
   =========================== */
...
export const IconShip: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M7 7v-4h-1v4"></path>
  </svg>
);

export const IconUserShield: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
export const IconFlag: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
    <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 5v16" /><path d="M5 5c4 0 5 2 8 2s4 -2 8 -2" /><path d="M5 14c4 0 5 2 8 2s4 -2 8 -2" />
  </svg>
);
...
/* ===========================
   ÍCONOS ADICIONALES (lucide)
   =========================== */

export const ShipIcon: React.FC<{ className?: string }> = ({ className }) => <Ship className={className} />;
export const DatabaseIcon: React.FC<{ className?: string }> = ({ className }) => <Database className={className} />;
export const AlertTriangleIcon: React.FC<{ className?: string }> = ({ className }) => <AlertTriangle className={className} />;